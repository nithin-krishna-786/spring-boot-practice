...
import com.nithin.springbootpractice.springdatajpa.Product;
import com.nithin.springbootpractice.springdatajpa.ProductRepository;
...
public class PaginationAndSortingTest {
    ...
    void sortingByMultipleFields(){
        ...
        Sort sortByName = sortDir.equalsIgnoreCase(Sort.Direction.ASC.name())?
                Sort.by(sortByNam).ascending(): Sort.by(sortByNam).descending();
