...
public class BigDecimalDemo {
	...
	public static void main(String[] args) {
        ...
        BigDecimal num2 = new BigDecimal("0.9999999999999999999999");
        ...
        BigDecimal num3 = new BigDecimal(fl1);
        BigDecimal num4 = new BigDecimal(fl2);
        BigDecimal sum2 = num3.add(num4); // Addition
